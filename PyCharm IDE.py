...
By using the PyCharm, we will get the below output.

Python unittest, python unit class example
Python Unit class Outcome & Basic Functions

This unittest has 3 possible outcomes. They are mentioned below:

    OK: If all class cases are passed, the output shows OK.
    Failure: If any of class cases failed and raised an AssertionError exception
...
Python unit class example

Now it’s time to write unit classes for our source class Person. In this class we have implemented two function – get_name() and set_name().
